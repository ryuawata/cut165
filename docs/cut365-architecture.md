...
The consumer calorie goal is the same rounded midpoint of the persisted minimum and maximum used by onboarding calculations. The historical min/max target model remains unchanged. Phase 4.7 removes the dedicated Drinks, Optional Cardio, and Today's Guidance interfaces without deleting their historical data or the ability to log alcohol through owned presets.
